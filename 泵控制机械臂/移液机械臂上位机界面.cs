...
namespace 机械臂控制软件
{
    public partial class 移液机械臂上位机界面 : Form
    {
        ...
        {
            if (robot1.HoleKeyPoint.Count < 4)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void numericUpDown_pumpmaxvel_ValueChanged(object sender, EventArgs e)
        {
            int speed = Convert.ToInt32(numericUpDown_pumpmaxvel.Value);
            robot1.DefPumpSpeed = speed;
        }
        /// <summary>
        /// 吸排量改变事件
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void numericUpDown_pumpvolume_ValueChanged(object sender, EventArgs e)
        {
            double volume = Convert.ToDouble(numericUpDown_pumpvolume.Value);
